...
\begin{exercise}[Connected and irreducible spaces]
  ...
  \begin{enumerate}
    ...
    \item Show that $\Spec R$ is irreducible with respect to the Zariski topology if and only if $R$ is an integral domain.
  \end{enumerate}
\end{exercise}

\begin{exercise}[Irreducible varieties]
\end{exercise}

\begin{exercise}[The affine line over a field]
\end{exercise}
