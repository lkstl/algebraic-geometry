...
%  \end{enumerate}
%\end{exercise}
\begin{exercise}[Characterization of prime ideals]
  Let $𝖆⊆R$ be an ideal of a commutative ring $R$.
  Prove equivalence of the following propositions:
  \begin{enumerate}
    \item $∀x_1,\dots,x_n ∈ R : ∏_{i=1}^n x_i ∈ 𝖆 ⇒ ∃i : x_i ∈ 𝖆$.
    \item $∀𝖆_1,\dots,𝖆_n ∈ \Idl(R) : ∏_{i=1}^n 𝖆_i ⊆ 𝖆 ⇒ ∃i : 𝖆_i ⊆ 𝖆$.
    \item $∀𝖆_1,\dots,𝖆_n ∈ \Idl(R) : ⋂_{i=1}^n 𝖆_i ⊆ 𝖆 ⇒ ∃i : 𝖆_i ⊆ 𝖆$.
  \end{enumerate}
\end{exercise}
