...
\begin{exercise}[Homogenization and dehomogenization]
  Consider the polynomial ring $R[X_0,\dots,X_n]$ over a commutative ring $R$.
  Show that for each $d ≥ 0$ and $i ∈ \{0,\dots,n\}$ homogenization and dehomogenization constitute inverse $R$-linear maps between the $R$-module $R[X_0,\dots,X_n]_d$ of $(n+1)$-variate homogeneous polynomials of degree $d$ and the $R$-module $R[X_0,\dots,\widehat{X_i},\dots,X_n]$ of $n$-variate polynomials of degree $≤d$.
\end{exercise}
