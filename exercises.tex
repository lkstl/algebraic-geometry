  ...
  \begin{enumerate}
    \item Denote the set of homogeneous ideals of $R$ which are not equal to the irrelevant ideal by $\Idl_+(R)$ and write $π:𝔸^{n+1}_K∖\{0\} → ℙ^n_K$ for the canonical projection.
      ...
      \[\begin{tikzcd}
        ...
        \arrow[""{name=2, anchor=center, inner sep=0}, "{𝒱_+}"', shift right=2, from=2-1, to=1-3]
        \arrow[""{name=3, anchor=center, inner sep=0}, "{ℐ_+}"', shift right=2, from=1-3, to=2-1]
    ...
    \item Was it really necessary to assume that $K$ is infinite?
      Find out which statements still hold if we drop this assumption.
  \end{enumerate}
\end{exercise}
