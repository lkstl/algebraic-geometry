...
\begin{exercise}[Homogeneous ideals]
  ...
  \begin{enumerate}
    ...
    \item Show that a homogeneous ideal $𝖕⊆K[X_0,\dots,X_n]$ is prime if and only if $fg ∈ 𝖕$ implies $f ∈ 𝖕$ or $g ∈ 𝖕$ for all homogeneous elements $f$ and $g$.
    \item Show that every homogeneous ideal $𝖆 ⊊ K[X_0,…,X_n]$ is contained in the \emph{irrelevant ideal} $(X_0,…,X_n)$.
  \end{enumerate}
\end{exercise}

\begin{exercise}[Determinantal varieties and nilpotent cones]
\end{exercise}
